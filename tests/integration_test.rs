...
fn issue_265() {
    ...
    sheet
        .get_cell_mut("A1")
        .get_style_mut()
        .set_background_color(umya_spreadsheet::Color::COLOR_BLACK);
    sheet.get_cell_mut("A1").set_value("COLOR_BLACK");
    sheet
        .get_cell_mut("A2")
        .get_style_mut()
        .set_background_color(umya_spreadsheet::Color::COLOR_WHITE);
    ...
    sheet
        .get_cell_mut("A4")
        .get_style_mut()
        .set_background_color(umya_spreadsheet::Color::COLOR_DARKRED);
    ...
    sheet
        .get_cell_mut("A6")
        .get_style_mut()
        .set_background_color(umya_spreadsheet::Color::COLOR_DARKBLUE);
    sheet.get_cell_mut("A6").set_value("COLOR_DARKBLUE");
    sheet
        .get_cell_mut("A7")
        .get_style_mut()
        .set_background_color(umya_spreadsheet::Color::COLOR_GREEN);
    sheet.get_cell_mut("A7").set_value("COLOR_GREEN");
    sheet
        .get_cell_mut("A8")
        .get_style_mut()
        .set_background_color(umya_spreadsheet::Color::COLOR_DARKGREEN);
    sheet.get_cell_mut("A8").set_value("COLOR_DARKGREEN");
    sheet
        .get_cell_mut("A9")
        .get_style_mut()
        .set_background_color(umya_spreadsheet::Color::COLOR_YELLOW);
    sheet.get_cell_mut("A9").set_value("COLOR_YELLOW");
    sheet
        .get_cell_mut("A10")
        .get_style_mut()
        .set_background_color(umya_spreadsheet::Color::COLOR_DARKYELLOW);
